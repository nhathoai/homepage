let main = (function () {
  ...
  function loadHtml(nameJson, activeClass) {
    ...
    Promise.all([
        ...
        //render footer
        if(select('.footer')){
          const htmlFooter = Mustache.to_html('<a href="#" class="back-to-top"> <div class="top"></div> <div class="arrow-up"></div> Top </a><!-- ======= Footer ======= --> <footer id="footer" class="footer"> <div class="footer-top"> <div class="container"> <div class="row gy-4"> <div class="col-lg-6 col-md-12 col-sm-12 footer-info"> <p class="name">{{name}}</p> <p class="mail">{{email}}</p> <p><a href="" onclick="return main.openHistory(0)">{{off_main_hcm}}</a> </p> <p><a href="" onclick="return main.openHistory(0)">{{off_hcm}}</a></p> <p><a href="" onclick="return main.openHistory(1)">{{off_hn}}</a></p> <p><a href="" onclick="return main.openHistory(1)">{{off_dn}}</a></p> </div> <div class=" footer-links-par col-lg-6 col-md-12  col-sm-12 d-flex justify-content-between"> <div class="footer-links  "> <h4>{{about}}</h4> <ul> <li><a href="#">{{message}}</a></li> <li><a href="#">{{company}}</a></li> <li><a href="#">{{history}}</a></li> </ul> </div> <div class="footer-links  "> <h4>What we do</h4> <ul> <li><a href="#">{{it}} </a></li> <li><a href="#">{{bpo}} </a></li> <li><a href="#">{{hr}} </a></li> </ul> </div> <div class="footer-links  "> <h4>Update</h4> <ul> <!-- <li><a href="#">{{blog}} </a></li> --> <!-- <li><a href="#">{{news}} </a></li> --> <li><a href="./recruit">{{recruit}} </a></li> <li><a href="#">{{interview}} </a></li> </ul> </div> <div class="footer-links  "> <h4>Contact</h4> <ul> <li><a href="#">{{contact}} </a></li> <li><a href="#">{{faq}} </a></li> </ul> </div> </div> </div> </div> </div> <div class="container"> <div class="copyright d-flex"> <p> ©PASONA TECH VIETNAM CO., LTD.</p> <a href="./policy">{{policy}}</a> </div> </div> </footer> <!-- End Footer -->', jsons[1][locale]);
          select('.footer').outerHTML = htmlFooter;
        }

        //start render main page
